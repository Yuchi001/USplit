...
namespace USplitAPI.Migrations
{
    ...
    [Migration("20250726224954_SpecifiedPrincipalKeyForTransactions")]
    partial class SpecifiedPrincipalKeyForTransactions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("USplitAPI.Domain.DebtEntity", b =>
                {
                    ...
                    b.HasOne("USplitAPI.Domain.TransactionEntity", "Transaction")
                        .WithMany("Debts")
